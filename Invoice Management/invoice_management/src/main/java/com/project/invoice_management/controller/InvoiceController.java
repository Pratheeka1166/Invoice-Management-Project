package com.project.invoice_management.controller;
...
import com.project.invoice_management.dto.InvoiceRequest;
import com.project.invoice_management.dto.OverdueRequest;
import com.project.invoice_management.dto.PaymentRequest;
import com.project.invoice_management.entity.Invoice;
import com.project.invoice_management.service.InvoiceService;
...
public class InvoiceController {
	...
	public ResponseEntity<Invoice> getInvoiceById(@PathVariable Long id) {
		return service.getInvoiceById(id).map(invoice -> new ResponseEntity<>(invoice, HttpStatus.OK))
